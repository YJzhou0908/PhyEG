...
namespace pe {
	...
	void GLLights::init() noexcept {
	}

	void GLLights::setupLights(std::vector<Light::Ptr>& lights) noexcept {
	...
	void GLLights::setupLightsView(const std::vector<Light::Ptr>& lights, const Camera::Ptr& camera) noexcept {
