...
namespace pe {
	...
	GLProgram::GLProgram(const Parameters::Ptr& parameters) noexcept {
		...
		mUniforms = GLUniforms::create(mProgram);
	...
	void GLProgram::replaceAttributeLocations(std::string& shader) noexcept {
	...
	void GLProgram::replaceLightNumbers(std::string& shader, const Parameters::Ptr& parameters) noexcept {
		//pattern-replace
		std::unordered_map<std::string, std::string> replaceMap = {
	...
	std::string GLProgram::getExtensionString() noexcept {
	...
	void GLProgram::uploadUniforms(UniformHandleMap& uniformMap, const GLTextures::Ptr& textures) {
		mUniforms->upload(uniformMap, textures);
	}

	//--------driver programs----------------------------
	GLPrograms::GLPrograms() noexcept {}

	GLPrograms::~GLPrograms() noexcept {}

	GLProgram::Ptr GLPrograms::acquireProgram(const GLProgram::Parameters::Ptr& parameters, HashType cacheKey) noexcept {
		...
		auto program = GLProgram::create(parameters);
	...
	UniformHandleMap GLPrograms::getUniforms(const Material::Ptr& material) noexcept {
	...
	HashType GLPrograms::getProgramCacheKey(const GLProgram::Parameters::Ptr& parameters) noexcept {
